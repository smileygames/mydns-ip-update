...
sudo wget -NP /usr/local/mydns-ip-update https://github.com/smileygames/mydns-ip-update/releases/download/v1.12/mydns-ip.conf
sudo chown root:root /usr/local/mydns-ip-update/mydns-ip.conf
sudo chmod 600 /usr/local/mydns-ip-update/mydns-ip.conf

sudo wget -NP /usr/local/mydns-ip-update/bin https://github.com/smileygames/mydns-ip-update/releases/download/v1.12/mydns-ip-update.sh
...
sudo wget -NP /usr/local/mydns-ip-update/bin https://github.com/smileygames/mydns-ip-update/releases/download/v1.12/mydns-ip-change.sh
...
sudo wget -NP /usr/local/mydns-ip-update/bin https://github.com/smileygames/mydns-ip-update/releases/download/v1.12/mydns-ip-common.sh
...
sudo wget -NP /usr/local/mydns-ip-update/bin https://github.com/smileygames/mydns-ip-update/releases/download/v1.12/mydns-ip-install.sh
...
sudo wget -NP /usr/local/mydns-ip-update/bin https://github.com/smileygames/mydns-ip-update/releases/download/v1.12/mydns-ip-uninstall.sh
